...
class PTYProcess(abstract.FileDescriptor, _BaseProcess):
    ...
    def _setupChild(self, mainfd, subordinatefd):
        ...
        This involves:
            ...
            - closing C{mainfd}, since it is not used in the subprocess

            - creating a new session with C{os.setsid}

            - changing the controlling terminal of the process (and the new
              session) to point at C{subordinatefd}

            - duplicating C{subordinatefd} to standard input, output, and error
        ...
        @param mainfd: The main end of a PTY file descriptors opened with
            C{openpty}.
        @type mainfd: L{int}

        @param subordinatefd: The subordinate end of a PTY opened with C{openpty}.
        @type subordinatefd: L{int}
        """
        os.close(mainfd)
        os.setsid()
